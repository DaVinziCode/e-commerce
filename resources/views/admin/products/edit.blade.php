                    ...
                    <form action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="mb-6 pt-3 rounded bg-gray-200">
                            ...
                            <input type="number" name="qty" id=""
                                class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3"
                                autocomplete="off"  value="{{ $product->qty }}">
                            @error('qty')
                                <p class="text-red-500 text-xs p-1">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="mb-6 pt-3 rounded bg-gray-200">
                            ...
                            <input type="number" name="actual_stock" id=""
                                class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3"
                                autocomplete="off"  value="{{ $product->actual_stock }}">
                            @error('actual_stock')
                                <p class="text-red-500 text-xs p-1">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="mb-6 pt-3 rounded bg-gray-200">
                            ...
                            <input type="number" name="stock_left" id=""
                                class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3"
                                autocomplete="off"  value="{{ $product->stock_left }}">
                            @error('stock_left')
                                <p class="text-red-500 text-xs p-1">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="mb-6 pt-3 rounded bg-gray-200">
                            ...
                            <input type="number" name="price" id="price"
                                class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3"  value="{{ $product->price }}"
                        ...
                        <div class="mb-6 pt-3">
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" value="{{$product->is_publish}}" class="sr-only peer" name="is_publish" id="is_publish_checkbox">
